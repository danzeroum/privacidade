...
const banco: Cenario = {
  ...
  titulares: [
    titular('t1', 'b', '274.065.813-77', 'Ana Beatriz Silva', 'ana.silva@exemplo.test',
    ...
    titular('t2', 'b', '843.117.902-08', 'Carlos Menezes', 'carlos.m@exemplo.test',
    ...
    titular('t3', 'b', '311.408.775-31', 'Joana Prado', 'joana.p@exemplo.test',
...
const varejo: Cenario = {
  ...
  titulares: [
    titular('t1', 'v', '712.334.908-11', 'Marina Costa', 'marina.c@exemplo.test',
    ...
    titular('t2', 'v', '905.221.744-60', 'Rafael Andrade', 'rafael.a@exemplo.test',
    ...
    titular('t3', 'v', '188.077.312-45', 'Beatriz Lopes', 'bia.l@exemplo.test',
...
const midia: Cenario = {
  ...
  titulares: [
    titular('t1', 'm', '404.882.113-90', 'Diego Rocha', 'diego.r@exemplo.test',
    ...
    titular('t2', 'm', '620.559.874-02', 'Helena Martins', 'helena.m@exemplo.test',
    ...
    titular('t3', 'm', '037.914.226-58', 'Tiago Nunes', 'tiago.n@exemplo.test',
